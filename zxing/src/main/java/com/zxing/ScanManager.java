...
public class ScanManager implements SurfaceHolder.Callback{
	...
	protected PhotoScanHandler photoScanHandler;
	Rect mCropRect = null;
	...
	synchronized void initCamera(SurfaceHolder surfaceHolder) {
	...
	public void handleDecode(Result rawResult, Bundle bundle) {
		if (rawResult == null) {
			rawResult = new Result(null, null, null, null);
		}
		...
		bundle.putString("result", rawResult.getText() == null?"":rawResult.getText());
...
//				Hashtable<DecodeHintType, String> hints = new Hashtable<DecodeHintType, String>();
				...
				try {
					...
					msg.obj = multiFormatReader.decodeWithState(bitmap1);
