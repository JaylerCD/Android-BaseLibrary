...
public final class BarUtils {
    ...
    public static void setNotificationBarVisibility(@NonNull Context context, final boolean isVisible) {
        String methodName;
        if (isVisible) {
    ...
    private static void invokePanels(@NonNull Context context, final String methodName) {
        try {
    ...
    public static void setNavBarVisibility(@NonNull final Activity activity, boolean isVisible) {
        ...
        setNavBarVisibility(activity, isVisible);
     ...
     * @param isVisible True to set navigation bar visible, false otherwise.
     */
    public static void setNavBarVisibility(@NonNull Context context, @NonNull final Window window, boolean isVisible) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
...
//    }
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isNavBarVisible(@NonNull Context context, @NonNull final Window window) {
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isSupportNavBar(@NonNull Context context) {
