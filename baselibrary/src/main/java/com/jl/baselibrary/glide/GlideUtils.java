...
public class GlideUtils {
     ...
     * 加载圆角图片
     */
    public static void loadRoundCircleImage(Context context, Object url, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .circleCrop()//设置圆形
                .placeholder(R.color.common_white)
     ...
     */
    public static void loadCustRoundCircleImage(Context context, Object url, ImageView imageView, RoundedCornersTransformation.CornerType type) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .placeholder(R.color.common_white)
                .error(R.color.common_white)
